            ...
            <div className='px-20'>
                <div className='cards w-full flex gap-20 mt-10'>
                    <motion.div
                        ...
                        <h1 className='absolute flex text-[#CDEA68] overflow-hidden right-0 translate-x-1/2 top-1/2 -translate-y-1/2 z-[9] text-8xl font-light'>
                    ...
                    <motion.div
                        ...
                        className='cardcontainer relative rounded-xl w-1/2 h-[75vh]'>
                        <div className='card w-full h-full rounded-xl overflow-hidden'>
                            <h1 className='absolute flex overflow-hidden text-[#CDEA68] right-full translate-x-1/2 top-1/2 -translate-y-1/2 z-[9] text-8xl font-light'>
            ...
            <div className='px-20'>
                <div className='cards w-full flex gap-20 mt-10'>
                    ...
                    <motion.div
                     ...
                     onHoverEnd={() => handleHoverEnd(0)}
                     className='cardcontainer relative rounded-xl w-1/2 h-[75vh]'>
                        <h1 className='absolute flex overflow-hidden text-[#CDEA68] left-full -translate-x-1/2 top-1/2 -translate-y-1/2 z-[9] text-8xl font-light'>
